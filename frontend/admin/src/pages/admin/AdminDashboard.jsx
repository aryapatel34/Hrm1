...
const AdminDashboard = () => {
  ...
  const pathRole = location.pathname.split('/')[1] || 'admin';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="p-6 h-[380px] flex flex-col">
          <div className="flex justify-between items-center mb-6">
            ...
            <button onClick={() => navigate(`/${pathRole}/notifications`)} className="text-xs font-bold text-blue-600 hover:underline">View All</button>
          </div>
          <div className="space-y-4 flex-1 overflow-y-auto pr-2">
